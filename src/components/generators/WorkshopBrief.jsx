  ...
  return (
    <div className="space-y-4">
      ...
      <div className="bg-gray-100 p-8 rounded-xl flex justify-center border border-gray-200">
        <div
          ref={briefRef}
          className="bg-white w-full max-w-3xl p-10 shadow-sm text-gray-900 rounded-lg print:shadow-none print:m-0 print:p-0"
          dir="rtl"
          style={{ fontFamily: "'Heebo', sans-serif", color: "black", background: "white" }}
        >
          {/* Header */}
